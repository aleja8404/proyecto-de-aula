...
public class DataInitializer {
    ...
    @Bean
    @Transactional // Ensure all database operations run in a single transaction
    public CommandLineRunner initDefaultUsers(UsuarioRepository usuarioRepository, RolRepository rolRepository) {
        return args -> {
            // Create Admin user
